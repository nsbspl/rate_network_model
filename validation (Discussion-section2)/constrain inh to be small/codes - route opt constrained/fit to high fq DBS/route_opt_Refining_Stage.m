...
for i = 1:num_iter
    ...
    [opt_fit_W,para_vec_P, ~, ~]  = Pushing_Function_Refining_Stage(para_vec_S, r_D_0, r_I_0,FR_time_hist,I_DBS,opt_para);
    ...
    [opt_fit_AP,para_vec_S, sim_r_e, sim_r_i]  = Stabilizing_Function_Refining_Stage(para_vec_P, r_D_0, r_I_0,FR_time_hist,I_DBS,opt_para);
