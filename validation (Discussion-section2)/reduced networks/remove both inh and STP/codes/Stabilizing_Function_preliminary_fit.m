...
% r_D_0 = 25;  FR_time_hist = FR_time_hist_conc; I_DBS = I_DBS_conc_p;
...
if  para_vec(1) < 0 || para_vec(2)< e_constant_lower_limit || para_vec(2)> e_constant_upper_limit  || para_vec(6) < baseline_FR_E_lower_limit || para_vec(6) > baseline_FR_E_upper_limit 
    SSE_now = 1e222*SSE_now;
end
