function [opt_fit_FR_f,para_vec, sim_r_e_f]  = Pushing_Function_Global_Stage_p(ini_para_vec, r_D_0, FR_time_hist,I_DBS)

%% Introduction (reduced network without I group)

% Pushing Function for Global Stage (w_ee is fixed)
