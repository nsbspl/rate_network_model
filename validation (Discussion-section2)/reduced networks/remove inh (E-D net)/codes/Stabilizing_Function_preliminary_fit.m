function [opt_fit_FR_f,para_vec, sim_r_e_f]  = Stabilizing_Function_preliminary_fit(ini_para_vec, r_D_0, FR_time_hist,I_DBS)

%% Introduction (reduced network without I group)

% Stabilizing Function for the preliminary fit
...
% ini_para_vec = ini_para_Tian_2023;
...
for i = 2:length(FR_time_hist)
    ...
    Wr_e = para_vec(1)*(sim_r(i-1) + sim_r_e(i-1));
...
%%  weight of each DBS frequency
 ...
 ratio_5 = 2000; ratio_10 = 100;ratio_20 = 400;ratio_30 = 500;ratio_50 = 3000;ratio_100 = 12000;ratio_200 = 42500; 
...
% 
% 
% if  para_vec(1) < 0.2 || para_vec(2)< e_constant_lower_limit || para_vec(2)> e_constant_upper_limit  || para_vec(6) < baseline_FR_E_lower_limit || para_vec(6) > baseline_FR_E_upper_limit ||  para_vec(4) > 0.01
...
for i = 2:length(FR_time_hist)
    ...
    Wr_e = para_vec(1)*(opt_fit_FR(i-1) + sim_r_e(i-1));    
