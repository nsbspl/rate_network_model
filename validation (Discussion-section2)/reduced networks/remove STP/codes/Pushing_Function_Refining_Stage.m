function [opt_fit_FR_f,para_vec_full, sim_r_e_f, sim_r_i_f]  = Pushing_Function_Refining_Stage(ini_para_vec, r_D_0, r_I_0, FR_time_hist,I_DBS)
...
% I_DBS: the DBS-induced post-synaptic current, represented as DBS waveform. 
% Data from all DBS frequencies {5,10,20,30,50,100,200Hz} are concatenated.
