function [opt_fit_FR_f,para_vec, sim_r_e_f, sim_r_i_f]  = Stabilizing_Function_preliminary_fit(ini_para_vec, r_D_0, r_I_0, FR_time_hist,I_DBS)
...
% ini_para_vec = [tau_i_0, Wee_0, Wie_0, Wei_0, Wii_0, tau_E_0, c_0, s_0, k_0, r_E_b_0]; initial parameters
...
% r_D_0 = 25;  r_I_0 = 5; FR_time_hist = FR_time_hist_conc; I_DBS = I_DBS_conc_p;
% ini_para_vec = ini_para_network_model;
% ini_para_vec = ini_para_4;
