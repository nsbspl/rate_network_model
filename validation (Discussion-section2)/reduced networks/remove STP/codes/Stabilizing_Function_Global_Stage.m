function [opt_fit_FR_f,para_vec, sim_r_e_f, sim_r_i_f]  = Stabilizing_Function_Global_Stage(ini_para_vec, r_D_0, r_I_0, FR_time_hist,I_DBS)

%% Introduction

% Stabilizing Function in Global Stage
