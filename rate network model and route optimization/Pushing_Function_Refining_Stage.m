...
if para_vec(1) < 2*para_vec(2) || para_vec(1) < i_constant_lower_limit ||  para_vec(2)< e_constant_lower_limit || para_vec(1) > i_constant_upper_limit || para_vec(2)> e_constant_upper_limit || para_vec(6) < baseline_FR_E_lower_limit || para_vec(6) > baseline_FR_E_upper_limit 
