...
%% input & output:
% The input x is defined as "the concatenated spike timings in seconds". 

% The output "optw" is the time histogram Gaussian kernel (in seconds), 
% which is the SD of a normal density function.

% run: x = conc_spk_timing; [y,t,optw] = sskernel_use(x);


function [y,t,optw,W,C,confb95,yb] = sskernel_use(x,tin,W)
