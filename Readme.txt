This folder contains the experimental data and codes for generating results of the paper: "Uncovering network mechanism underlying thalamic Deep Brain Stimulation using a novel firing rate model". 
